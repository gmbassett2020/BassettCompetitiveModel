...
class GameSimulator:
   ...
   def SetWeekWeightsToBestFit(self):
      ...
      bestWeights = [0.7941167790817569, 0.7195257962111826, 0.7574704435994234, 0.7948800055001095, 0.8262671256461386, 0.8557465042369405, 0.8813065655037028, 0.9058579695882067, 0.928092095456229, 0.9493606398415331, 0.9662703181070563, 0.9720919860088111, 0.9938275247806949, 1.0]
      while (len(bestWeights) < self.maxWeekWeightCount):
         bestWeights.append(1.)
